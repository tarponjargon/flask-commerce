...
module.exports = defineConfig({
  ...
  e2e: {
    ...
    // },
    baseUrl: "https://misc:misc@flaskcommerce.thewhiteroom.com",
  },
  env: {
    baseUrl: "https://misc:misc@flaskcommerce.thewhiteroom.com", // NOTE: e2e.baseUrl does not seem to work locally
    isFailover: 0,
